...
create table `member_info`(
	`id` unsigned bigint not null auto_increment comment '会员id',
	...
	`is_available` unsigned tinyint(1) default '0' comment '可用标识(0-不可用;1-可用)',
...
create table `member_bankcard`(
    `id` unsigned bigint not null auto_increment comment 'id',
	...
	`member_info_id` unsigned bigint not null comment '会员id',
...
create table `trade_log`(
    `id` unsigned bigint not null auto_increment comment '交易记录id',
